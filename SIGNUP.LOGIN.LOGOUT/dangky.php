...
<div class="thanhbar">
    ...
    <form class="login_form">
        <div class="email">
            <div class="font">Điện thoại hoặc Email</div>
...
<section>
    <div class="signup_body">
        ...
        <form class="signup_form">
            <div>
                <input class="firtsname" type="text" name="" placeholder="First name">
                <input class="lastname" type="text" name="" placeholder="Last name">
                <input class="email" type="text" name="" placeholder="Số điện thoại hoặc email">
                <input class="password" type="password" name="" placeholder="Passwword">
                <input class="password2" type="password" name="" placeholder="Confirm Passwword">
            </div>
